...
export class IndexEntry {
  ...
  constructor(path, oid, stat) {
    const mode = isExec(stat) ? IndexEntry.EXECUTABLE_MODE : IndexEntry.REGULAR_MODE;
  ...
  toString() {
    ...
    const paddingSize = IndexEntry.ENTRY_BLOCK - (totalSize % IndexEntry.ENTRY_BLOCK);
    ...
    /*
      Added extra 4 bytes header field for size (It is not there in original git implmentation)
    */
